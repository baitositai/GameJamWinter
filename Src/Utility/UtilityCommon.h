...
public:
	...
	/// <summary>
	/// 値をstep分増減させて、範囲内に循環させる
	/// </summary>
	/// <param name="index">現在の値</param>
	/// <param name="step">増減値</param>
	...
	/// 指定した桁数の数字を返す
	/// </summary>
	/// <param name="value">桁値を求める値</param>
	/// <param name="digit">桁数</param>
	/// <returns>桁値</returns>
	static int GetDigit(const int value, const int digit);

	/// <summary>
	/// 桁数を返す
	/// </summary>
	/// <param name="value">桁数を調べる値</param>
	/// <returns>桁数</returns>
